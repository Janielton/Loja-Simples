...
use Controllers\ControllerView;
use Routes\Request;
use Routes\Dispacher;
use Routes\RouteCollection;
require "routes/dispacher.php"; 
require "routes/routeCollection.php"; 
class Router 
{
	...
	protected function dispach($route, $params, $namespace = "Controllers\\"){
